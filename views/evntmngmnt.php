        ...
        <table height=635 width=1080>
            ...
            <tr>
                ...
                <ul>
                    ...
                    <li> <a href="send_msg1.php">Help and Support</a></li>				  					
				...
				<fieldset>
                    ...
                    <br />
                    Event Sponsers:  <input type="text" name="phone" id="phone" />
                    <br />
                    Event Desc:<input type="text" name="evntdesc" id="evntdesc" > <br>
                    Event Start Date: <input type="date" name="esd" id="esd" > <br>
                    Event End Date: <input type="date" name="eed" id="eed" > <br>
                    Event location: <input type="text" name="el" id="el" > <br>
