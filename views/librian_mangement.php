    ...
    <center>
        ...
        <table height=635 width=1080>
            ...
            <tr>
                ...
                <td>                    
				<fieldset>
                    <legend>Librian-Management</legend>
                    <table height="30" width="500">
                     <li><a href="Addnewlibrian.php">Add Librian</a></li> 
                     <li><a href="Updatenewlibrian.php">Update Librian</a></li>
                     <li><a href="Deletenewlibrian.php">Delete Librian</a></li> 
</table>                  
                </fieldset>
                </td>
            </tr>
